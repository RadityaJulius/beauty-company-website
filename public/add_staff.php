    ...
    <div class="flex-1">
      ...
      <div class="bg-gray-100 flex items-center justify-center min-h-screen">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl">
          ...
          <form method="POST" action="../src/create_staff.php">
            <div class="mb-4">
            ...
            <div class="mb-4 flex space-x-4">
              <div class="w-1/2">
                <label class="block text-gray-700 mb-2" for="working-hours">Working Hours</label>
            ...
            <button class="w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700" type="submit" name="submit">Add
              Staff</button>
          </form>
        </div>
